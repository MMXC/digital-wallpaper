...
### v1.2.0 (2026-03-13)
- ✨ **本地后台管理**: 新增 `admin.html` - 本地管理界面，支持配置管理、用户管理、日志查看
- ✨ **天空盒预览**: 新增 `preview.html` - 3D 天空盒场景预览，支持多种天空效果切换
- ✨ **静态壁纸导出**: 新增 `export.html` - 静态壁纸生成工具，支持自定义背景、文字、边框
- ⚡ **性能优化**: 主进程 `main.js` 优化，减少内存占用
- 🔒 **安全增强**: `preload.js` 强化上下文隔离
